...
output: 
  html_document:
    toc: true
    code_folding: hide
    ## this style.css file just increases the max width of the document, feel free to change inside the file
    css: style.css
---
...
```{r, fig.fullwidth = TRUE, fig.width = 16}
...
```
### Difference in proteins quantified between 30 and 60 SPD
...
vec_KO_genes <- c("P42345", "P37023", "P29474", "P35414", "O14874", "Q6Q0C0", "P00492",
                  "O95490", "Q9ULZ1", "Q9Y5W3", "P11308", NA, "P23467", "Q9H4F8", "Q16270",
                  ## which FGFR? There are 4
                  "P11362", "Q96CH1", "Q9H6K1", "P25963")
## make the controls, aka denominator
vec_control_conditions <- c("AAVS1_G1G2", "HPRT_G1G2", "HPRT_G1")
vec_experimental_conditions <- levels(df_30$GROUP)[!(levels(df_30$GROUP) %in% vec_control_conditions)]
vec_unique_groups <- unique(df_30$GROUP)
